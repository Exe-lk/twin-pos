...
const Index: NextPage = () => {
	...
	const [editModalStatus] = useState<boolean>(false); // State to control the visibility of the Edit Seller modal
	const [seller, setStock] = useState<Seller[]>([]); // State to store the seller data fetched from Firestore
	const [id, seId] = useState<string>(''); // State to store the ID of the seller being edited
	...
	useEffect(() => {
		...
		fetchData();
	}, [editModalStatus, addModalStatus]); // Dependency array: useEffect runs when addModalStatus or editModalStatus changes
	return (
		<PageWrapper>
			<Head>
				<></>
